...
export interface INiceErrorJsonObject<ERR_DEF extends INiceErrorDefinedProps = INiceErrorDefinedProps, ID extends keyof ERR_DEF["schema"] = keyof ERR_DEF["schema"]> {
    name: "NiceError";
