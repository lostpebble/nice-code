      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            "Errors that ",
            React.createElement("em", null, "survive"),
            React.createElement("br"),
            "the ",
            React.createElement("span", { className: "acc" }, "network."),
          ),
          React.createElement(
            "p",
    ...
    if (heroVariant === "Editorial") {
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { className: "hero-actions", style: { marginTop: 40 } },
            React.createElement(
              "a",
              {
                className: "btn primary",
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          "Typed ",
          React.createElement("em", null, "errors"),
          ".",
          React.createElement("br"),
          "Typed ",
          React.createElement("span", { className: "acc" }, "actions"),
          ".",
          React.createElement("br"),
          "Zero ",
          React.createElement("em", null, "string-casts"),
          ".",
        ),
        React.createElement(
          "p",
        ...
        React.createElement(
          ...
          React.createElement(
            "button",
            {
              ...
              onClick: () =>
                navigator.clipboard &&
                navigator.clipboard.writeText("bun add @nice-code/error @nice-code/action"),
            },
            React.createElement(
              "svg",
              {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        [
          {
            ft: "Typed context",
            fd: "Context flows from creation through narrowing to access — no casts.",
            d: "M2 8l3 3 7-7",
          },
          {
            ft: "Safe on the wire",
            fd: "Serialize to JSON, reconstruct on the other side — same types.",
            d: "M2 5h12M2 11h12",
          },
          {
            ft: "Pattern matching",
            fd: "handleWith, matchFirst, forDomain, forIds — exhaustive and typed.",
            d: "M4 4h3v3H4zM9 4h3v3H9zM4 9h3v3H4zM9 9h3v3H9z",
          },
          {
            ft: "Works everywhere",
            fd: "HTTP, RPC, Web Workers, Durable Objects — built for the edge.",
            d: "M8 2 2 8l6 6 6-6z",
          },
        ].map((f, i) =>
          React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        "Use errors alone, or add actions on top. Every API composes — errors declared with ",
        React.createElement("code", null, "defineNiceError"),
        " plug straight into action ",
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "p",
            { className: "pkg-lede" },
            "Declare your error schema up front. Every id, every context field, every http status — typed and reachable from any catch.",
          ),
          React.createElement(
            "ul",
            { className: "pkg-bullets" },
            ...
            React.createElement("li", null, "castNiceError · handleWithSync· matchFirst"),
          ...
          React.createElement(
            ...
            {
              className: "pkg-cta",
              href: "#/docs/err-domains",
              onClick: (e) => {
                e.preventDefault();
                onNavigate("/docs/err-domains");
              },
            },
            "Read the guide →",
          ),
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            null,
            "Actions that ",
            React.createElement("em", null, "travel"),
          ),
          React.createElement(
            "p",
            { className: "pkg-lede" },
            "Typed request/response pairs with schema validation and custom serialization. Dispatch locally or across a wire — the client never has to care.",
          ),
          React.createElement(
            "ul",
            { className: "pkg-bullets" },
          ...
          React.createElement(
            ...
            {
              className: "pkg-cta",
              href: "#/docs/act-domains",
              onClick: (e) => {
                e.preventDefault();
                onNavigate("/docs/act-domains");
              },
            },
            "Read the guide →",
          ),
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        { className: "section-title" },
        "From ",
        React.createElement("em", null, "throw"),
        " to ",
        React.createElement("em", null, "catch"),
        " —",
        React.createElement("br"),
        "same types, different continent.",
      ),
      React.createElement(
        "div",
        ...
        React.createElement(CodeBlock, {
          tabs: [
            {
              label: "server.ts",
              code: `[[cm|// Server — throw and serialize]]
  ...
  [[prop|status]]: [[var|error]][[p|.]][[prop|httpStatusCode]]
        ...
        React.createElement(CodeBlock, {
          tabs: [
            {
              label: "client.ts",
              code: `[[cm|// Client — cast, narrow, act]]
